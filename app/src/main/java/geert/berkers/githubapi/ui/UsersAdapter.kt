...
/**
 * A simple adapter implementation that shows Github users.
 */
class UsersAdapter(private val glide: GlideRequests)
    : PagingDataAdapter<Item, UserItemViewHolder>(ITEM_COMPARATOR) {
...
//            holder.updateScore(item)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserItemViewHolder {
        return UserItemViewHolder.create(parent, glide)
    }
